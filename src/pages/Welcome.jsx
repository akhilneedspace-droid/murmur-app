...
export default function Welcome() {
  ...
  return (
    <div className="page" style={{ position: 'relative', justifyContent: 'space-between', minHeight: '100dvh' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1, padding: '52px 28px 0', marginTop: '20vh', opacity: visible ? 1 : 0, transform: visible ? 'translateY(0)' : 'translateY(-12px)', transition: 'opacity 0.6s ease, transform 0.6s ease' }}>
